...
class View{
	...
	DisplayBoard(playerIndex){
		this.grid[0][0].style.borderTopLeftRadius = "40%";this.grid[0][0].style.borderTop = "none";this.grid[0][0].style.borderLeft = "none";
		this.grid[9][0].style.borderBottomLeftRadius = "40%";this.grid[9][0].style.borderBottom = "none";this.grid[9][0].style.borderLeft = "none";
		this.grid[0][9].style.borderTopRightRadius = "40%";this.grid[0][9].style.borderTop = "none";this.grid[0][9].style.borderRight = "none";
		this.grid[9][9].style.borderBottomRightRadius = "40%";this.grid[9][9].style.borderBottom = "none";this.grid[9][9].style.borderRight = "none";
		for(let x=0; x<10; x++){
			for(let y=0; y<10; y++){
	...
	initPawns(){
		...
		for (let i = 0; i<12; i++){
			count[i]=0;
			html+= '<li class="pawn-item" id="pawn'+i.toString()+'" draggable="true" ondragstart="onDragStart(event);" data-value='+i.toString()+'><img src="../images/stratego-bomb.svg"><p>'+count[i]+'/'+max[i]+'</p></li>';
		}
